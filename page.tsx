...
export default function Home() {
  ...
  const handleKeyPress = useCallback((e: React.KeyboardEvent) => {
    if (e.key === 'Enter' && !loading && player && line) {
      analyze()
    }
              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={loading}
                    className="w-full px-4 md:px-6 py-3 md:py-4 bg-black border-2 border-zinc-800 rounded-xl text-white text-base md:text-lg placeholder-gray-600 focus:border-orange-500 focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      disabled={loading}
                      className="w-full px-4 md:px-6 py-3 md:py-4 bg-black border-2 border-zinc-800 rounded-xl text-white text-base focus:border-orange-500 focus:outline-none transition-all appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      disabled={loading}
                      className={`py-3 md:py-4 rounded-xl font-bold text-base md:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                        betType === 'over'
                ...
                <div className="mx-6 md:mx-8 mb-6 md:mb-8 p-4 bg-red-500/10 border border-red-500/50 rounded-xl">
                  ...
                  {needsAuth && (
                    <p className="text-red-300 text-xs mt-2">
                      Authentication coming soon. For now, the app runs in demo mode.
                    </p>
                  )}
                </div>
              )}
